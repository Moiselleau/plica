...
export class PhotoControllerBase {
  ...
  async AddPhoto(
    ...
    return this.service.AddPhoto(body);
  }

  @common.Delete("/delete-photo/:id")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  @common.Post("/set-profile-photo/:id")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async SetProfilePhoto(
    ...
    return this.service.SetProfilePhoto(body);
  }
}
